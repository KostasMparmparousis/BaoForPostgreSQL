...
DB_URL_TEMPLATE = "postgresql://suite_user:71Vgfi4mUNPm@train.darelab.athenarc.gr:5468/{db_name}"
...
def get_alchemy_engine(db_name):
    ...
    global engine
    if engine is None:
        db_url = DB_URL_TEMPLATE.format(db_name=db_name)
...
def main():
    ...
    if not prepare_and_start_bao_server():
        return
